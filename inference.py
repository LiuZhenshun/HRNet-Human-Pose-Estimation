...
from core.function import validate, infernce2json
...
def main():
    ...
    from dataset.inference2json import inference2json_dataset
    valid_dataset = inference2json_dataset(
        jsonfile, num_joints, inputsize,
        transforms.Compose([
            transforms.ToTensor(),
            normalize,
        ])
